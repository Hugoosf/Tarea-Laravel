...
<nav class="navbar navbar-expand-lg navbar-light bg-light border">
    ...
    <div class="row">
        ...
        <?php endif; ?>
        <form action="<?php echo e(url('/tres')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="mb-3">
...
<?php endif; ?><?php /**PATH C:\Users\hugosf\Downloads\Proyectolara\picto\resources\views/catalog/tres.blade.php ENDPATH**/ ?>